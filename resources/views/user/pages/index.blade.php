        ...
        <div class="container">
            <div class="row">
                <div class="categories__slider owl-carousel">
                    ...
                    <div class="col-lg-3">
                        <div class="categories__item set-bg" data-setbg="{{ asset('user/img/categories/cat-5.jpg') }}">
                            <h5><a href="#">drink fruits</a></h5>
                        </div>
                    </div>
                </div>
                ...
                @foreach ($books as $book)
                    <div class="col-lg-3 col-md-4 col-sm-6">
                        <div class="featured__item">
                            <div class="featured__item__pic set-bg" data-setbg="{{ $book->image }}">
                                <ul class="featured__item__pic__hover">
                                    {{-- <li><a href="#"><i class="fa fa-heart"></i></a></li>
                                    <li><a href="#"><i class="fa fa-retweet"></i></a></li> --}}
                                    <li><a data-id="{{ $book->id }}" data-name="{{ $book->name }}"
                                            data-code="{{ $book->code }}" data-image="{{ $book->image }}"
                                            data-price="{{ $book->price }}" class="js-addCart"><i
                                                class="fa fa-shopping-cart"></i></a></li>
                                </ul>
                            </div>
                            <div class="featured__item__text">
                                <h6><a href="{{ route('user.detail', $book->id) }}">{{ $book->name }}</a></h6>
                            ...
                            <div class="latest-prdouct__slider__item">
                                <a href="#" class="latest-product__item">
                                    <div class="latest-product__item__pic">
                                        <img src="{{ asset('user/img/latest-product/lp-1.jpg') }}" alt="">
                                    </div>
                                ...
                                <a href="#" class="latest-product__item">
                                    <div class="latest-product__item__pic">
                                        <img src="{{ asset('user/img/latest-product/lp-2.jpg') }}" alt="">
                                    </div>
                                    <div class="latest-product__item__text">
                                        <h6>Crab Pool Security</h6>
                                        <span>$30.00</span>
                                ...
                                <a href="#" class="latest-product__item">
                                    <div class="latest-product__item__pic">
                                        <img src="{{ asset('user/img/latest-product/lp-3.jpg') }}" alt="">
                                    </div>
                                    <div class="latest-product__item__text">
                                        <h6>Crab Pool Security</h6>
                                        <span>$30.00</span>
    ...
    <script>
        $(document).ready(function() {
            $('.js-addCart').on('click', function(e) {
                ...
                let productImg = $(this).data('image');

                addToCart(productId, productName, productCode, productPrice, productImg)

                getTotalCart()

                $.toast({
                    heading: 'Thành công',
                    text: 'Thêm sách vào giỏ hàng thành công    ',
                    position: 'top-right',
                    stack: false,
                    icon: 'success'
                })
        ...
        //Add item to cart
        function addToCart(productId, productName, productCode, productPrice, productImg) {
